...
landmarks_per_finger = {
    'THUMB': {'THUMB_CMC': THUMB_CMC, 'THUMB_MCP': THUMB_MCP, 'THUMB_IP': THUMB_IP, 'THUMB_TIP': THUMB_TIP},
...
joint_neighbours_left_hand = {
    ...
    INDEX_FINGER_MCP: [THUMB_CMC, MIDDLE_FINGER_MCP],
    INDEX_FINGER_PIP: [THUMB_MCP, MIDDLE_FINGER_PIP],
    INDEX_FINGER_DIP: [THUMB_IP, MIDDLE_FINGER_DIP],
    INDEX_FINGER_TIP: [THUMB_TIP, MIDDLE_FINGER_TIP],
